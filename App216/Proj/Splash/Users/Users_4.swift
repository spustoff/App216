...
struct Manager: View {
    ...
    var body: some View {
        ...
        ZStack {
            ...
            LinearGradient(colors: [Color("bg"), Color("blue")], startPoint: .bottom, endPoint: .top)
                .ignoresSafeArea()
            ...
            if let contact = viewModel.contact {
                ...
                VStack {
                    ...
                    WebPic(urlString: contact.photo ?? "", width: 255, height: 255, cornerRadius: 0, isPlaceholder: false)
                        .padding(.top, 100)
...
class Users_4ViewModel: ObservableObject {
    ...
    func fetchContact() {
        ...
        let request = AF.request("https://cleontiss.space/api/v2/contact/oopp0rtunity", method: .get, parameters: params)
